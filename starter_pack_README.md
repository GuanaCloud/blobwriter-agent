# kai-blobwriter-agent

AI-driven agent designed to facilitate the exploration of the blogger agent landscape
...
```
kai-blobwriter-agent/
├── blogger_agent/                 # Core application code
...
2. **Integrate:** Import your agent into the app by editing `blogger_agent/agent.py`.
...
bq query --use_legacy_sql=false \
  "SELECT * FROM \`kai-blobwriter-agent_telemetry.completions\` LIMIT 10"
```
