...
from blogger_agent.app_utils.gcs import create_bucket_if_not_exists
from blogger_agent.app_utils.telemetry import setup_telemetry
from blogger_agent.app_utils.typing import Feedback
...
bucket_name = f"gs://{project_id}-kai-blobwriter-agent-logs"
...
app.title = "kai-blobwriter-agent"
app.description = "API for interacting with the Agent kai-blobwriter-agent"
